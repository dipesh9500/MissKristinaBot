...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import KristinaBot.events

        path = Path(f"KristinaBot/modules/{shortname}.py")
        name = "KristinaBot.modules.{}".format(shortname)
        ...
        mod.KristinaBot = KristinaBot
        mod.tbot = telethn
        mod.logger = logging.getLogger(shortname)
        spec.loader.exec_module(mod)
        sys.modules["KristinaBot.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "KristinaBot/modules/*.py"
