...
from KristinaBot.modules import ALL_MODULES
from KristinaBot.modules.helper_funcs.chat_status import is_user_admin
from KristinaBot.modules.helper_funcs.misc import paginate_modules
...
buttons = [
    ...
    [
        InlineKeyboardButton(text="ꜱᴜᴘᴘᴏʀᴛ", url=f"https://t.me/KristinaSupportGroup"
    ],
    [
        InlineKeyboardButton(text="ᴏᴡɴᴇʀ", url=f"https://t.me/DIPESH_XD"       
    ],
    [
        InlineKeyboardButton(   text="ʟᴏɢs", url=f"https://t.me/KRISTINALOGS"            
    ],
    [
...
kristina_IMG = "https://telegra.ph/file/47ab7aa054a25224cbac8.jpg"
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("KristinaBot.modules." + module_name)
    ...
    if query.data == "kristina_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Back", callback_data="kristina_back")
                 ]
                ]
            ),
        )
    elif query.data == "kristina_back":
        query.message.edit_text(
                PM_START_TEXT,
                reply_markup=InlineKeyboardMarkup(buttons),
                parse_mode=ParseMode.MARKDOWN,
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(kristina_about_callback, pattern=r"kristina_")
